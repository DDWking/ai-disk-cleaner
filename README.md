...
[Release v2.12.0](https://github.com/DDWking/ai-disk-cleaner/releases/tag/v2.12.0) 里有 Windows x64 压缩包。解压后右键 `AiDiskCleaner.exe` → 以管理员身份运行。需要已安装 [.NET 8 桌面运行时](https://dotnet.microsoft.com/download/dotnet/8.0)。
